<?php
/*
 *  Author: Mario Eichler | @mario_eichler
 *  URL: bgranzow.de
...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
     ...
     //    wp_enqueue_script('conditionizr'); // Enqueue it!
        ...
        wp_register_script('jquery', '//ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js', array(), '1.11.3', true);
        wp_enqueue_script('jquery'); // jquery via CDN

        wp_register_script('bootstrapJS', '//maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js', array(), '3.3.6', true);
...
{
    // wp_register_style('bootstrapcdn', '//maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css', array(), '3.3.6', 'all');
	...
	<?php endif; ?>
    	<div class="comment-author vcard clearfix">
    	   <div class="avatar">
            ...
            <div class="comment-meta-date"><a href="<?php echo htmlspecialchars( get_comment_link( $comment->comment_ID ) ) ?>">
		...
		array (
			...
			'layouts' => array (
				array (
					...
					'sub_fields' => array (
						...
						array (
							...
							'sub_fields' => array (
								array (
									'key' => 'field_5813557ed349e',
									'label' => 'Profile Links Icon',
									'name' => 'profile_links_icon',
									'type' => 'text',
									'instructions' => 'Font Awesome Icon Bezeichnung hier eintragen.',
									'required' => 0,
									'conditional_logic' => 0,
									'wrapper' => array (
										'width' => '',
								...
								array (
									'key' => 'field_581355afd349f',
									'label' => 'Profile Links Link',
									'name' => 'profile_links_link',
									'type' => 'url',
									'instructions' => 'Ziellink eintragen.',
									'required' => 0,
									'conditional_logic' => 0,
									'wrapper' => array (
										'width' => '',
				...
				array (
					...
					'sub_fields' => array (
						array (
							'key' => 'field_57271686347af',
							'label' => 'Icon',
							'name' => 'icon',
							'type' => 'text',
							'instructions' => 'Icon Name (z.B. time) eintragen von https://fortawesome.github.io/Font-Awesome/ - wird dann im HTML als <i class="fa fa-time"></i> eingesetzt.',
							'required' => 0,
							'conditional_logic' => 0,
							'wrapper' => array (
								'width' => '',
				...
				array (
					...
					'sub_fields' => array (
						array (
							...
							'max' => '',
							'layout' => 'table',
							'button_label' => 'Add Skillgroup',
							'sub_fields' => array (
								array (
									'key' => 'field_572719dbb9c84',
									'label' => 'Icon',
									'name' => 'icon',
									'type' => 'text',
									'instructions' => 'Icon Name (z.B. time) eintragen von https://fortawesome.github.io/Font-Awesome/ - wird dann im HTML als <i class="fa fa-time"></i> eingesetzt.',
								...
								array (
									...
									'sub_fields' => array (
										...
										array (
											'key' => 'field_572719afcdd24',
											'label' => 'Skillrating',
											'name' => 'skillrating',
											'type' => 'select',
											'instructions' => '25, 50, 75 oder 100 (Grundkenntnisse, Fortgeschritten, Erfahren, Experte)',
											'required' => 0,
											'conditional_logic' => 0,
											'wrapper' => array (
												'width' => '',
				...
				array (
					'key' => '572717a0bd162',
					'name' => 'aboutme_contact_form',
					'label' => 'Contact Form',
					'display' => 'block',
					'sub_fields' => array (
						array (
							'key' => 'field_57272ba30e6ae',
							'label' => 'Icon',
							'name' => 'icon',
							'type' => 'text',
							'instructions' => 'Icon Name (z.B. time) eintragen von https://fortawesome.github.io/Font-Awesome/ - wird dann im HTML als <i class="fa fa-time"></i> eingesetzt.',
						...
						array (
							...
							'sub_fields' => array (
								array (
									'key' => 'field_57271844bd166',
									'label' => 'Option',
									'name' => 'option',
									'type' => 'text',
									'instructions' => 'Option für Dropdown Feld',
									'required' => 0,
									'conditional_logic' => 0,
									'wrapper' => array (
										'width' => '',
...
acf_add_local_field_group(array (
	'key' => 'group_573c51af48707',
	'title' => 'Posts',
	'fields' => array (
		array (
			'key' => 'field_573c5e5d27fac',
			'label' => 'Tabelle Überschrift',
			'name' => 'table_heading',
			'type' => 'text',
			'instructions' => '',
			'required' => 0,
